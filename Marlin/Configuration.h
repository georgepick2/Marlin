...
#define STRING_CONFIG_H_AUTHOR "(GeorgePick, Ender-5 Pro)" // Who made the changes.
...
//  #define DEFAULT_bedKd 305.4
    #define DEFAULT_bedKp 126.50
    #define DEFAULT_bedKi 20.81
    #define DEFAULT_bedKd 512.77
